...
# Brainstorm: Team access foundation

## Focus Question

Execute canonical GitHub spec #14 without changing its reviewed boundary.

## Desired Outcome

Ship Phase 2D team access with tenant-safe persistence, soft lifecycle,
deterministic concurrency, exact APIs, and complete verification.

## Vision

Organization teams reduce repetitive direct grants while preserving fixed scopes,
direct-grant compatibility, forensic auditability, and immediate authorization.

## Supporting Material

- https://github.com/JimmyMcBride/brain-cloud/issues/14
- https://github.com/JimmyMcBride/brain-cloud/issues/12
- https://github.com/JimmyMcBride/brain-cloud/pull/13

## Constraints

- GitHub issue #14 is canonical.
- Preserve Phase 2C direct access contracts.
- Implement no deferred identity, policy-engine, UI, or module work.
...
- Explicit teams, membership links, and team project grants.
- Dormant retained links/grants through soft deactivation.
- Serialized team mutations and conflict-safe upserts.

## Raw Notes

Execution source reconstructed from canonical GitHub issue #14.
...
Owners manage reusable team access without repeated per-person project grants.

### Appetite

One bounded Phase 2D implementation and ready PR.
...
- Reviewed #14 approach: explicit schemas, direct authorization query, soft lifecycle.
- Rejected: hard deletion, generic policy engine, materialized effective grants.

### Decision Snapshot

Implement #14 exactly.

## Challenge

### Rabbit Holes

- Nested teams, custom roles, deny rules, invitations, agents, UI, generic policy engine.

### No-Gos

- No hard team deletion.
- No scope elevation for partial credentials.
- No unaudited or non-deterministic authorization mutations.

### Assumptions

- PostgreSQL row locks and unique constraints provide required serialization.
- Existing fixed reader/editor access levels remain sufficient.

### Likely Overengineering

Abstracting authorization beyond explicit direct and team grant paths.

### Simpler Alternative

Explicit Ecto schemas and context functions matching current Phoenix architecture.

## Promotion map

### Spec 1 — Team access foundation
...
Dependencies: Phase 2C project access control is merged.
