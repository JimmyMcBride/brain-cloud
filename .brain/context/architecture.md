...
- `scripts/phase2-upgrade-test.sh` verifies deterministic Phase 1 migration and explicit legacy adoption. `scripts/phase2-smoke.sh` verifies release bootstrap/recovery, token lifecycle, two-organization isolation, API restart durability, and PostgreSQL outage/recovery.
