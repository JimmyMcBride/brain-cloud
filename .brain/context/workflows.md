...
- `compose.yaml`: Phoenix release, PostgreSQL, and a development-only Mailpit SMTP sink; operators create the initial organization owner through `/app/bin/bootstrap_owner`.
