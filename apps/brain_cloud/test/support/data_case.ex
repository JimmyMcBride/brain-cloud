defmodule BrainCloud.DataCase do
  @moduledoc """
  ...
  by setting `use BrainCloud.DataCase, async: true`, although
  ...
  def setup_sandbox(tags) do
    pid = Ecto.Adapters.SQL.Sandbox.start_owner!(BrainCloud.Repo, shared: not tags[:async])
